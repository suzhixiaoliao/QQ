...
public class MyImgFilter {
    ...
    public static void main(String[] args) throws IOException {
    	for(int i=0;i<QQUtil.imageAmount;i++){
    		String filePath= QQUtil.imagePath+i+".jpg";
    		 FileInputStream fin=new FileInputStream(filePath);
    	        ...
    	        String pname=filePath.substring(QQUtil.imagePath.length(),filePath.lastIndexOf("."));  
    	        File file = new File(QQUtil.processImagePath+pname+".jpg");
